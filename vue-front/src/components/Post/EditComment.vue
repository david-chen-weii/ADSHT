        ...
        <div class="modal-body">
          <form @submit.prevent="submitPost">
            <div class="mb-2">
              ...
              <input type="text" class="form-control form-control-sm" id="productName" v-model="newProduct.productName"
                required>
            </div>

            <div class="mb-2">
              <label for="productPrice" class="form-label">價格</label>
              <input type="number" class="form-control form-control-sm" id="productPrice" v-model="newProduct.price"
                required>
            </div>

            <div class="mb-2">
              <label for="productDescription" class="form-label">商品描述</label>
              <textarea class="form-control form-control-sm" id="productDescription" v-model="newProduct.description"
                rows="2" required></textarea>
            </div>

            <div class="mb-2">
              <label for="productStock" class="form-label">庫存</label>
              <input type="number" class="form-control form-control-sm" id="productStock" v-model="newProduct.stock"
                required>
            </div>
...
.image-preview img {
  ...
  /* Border radius for image preview */
}

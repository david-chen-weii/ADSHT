	...
	<div class="section over-hide">
		<div class="container">
			<div class="row full-height justify-content-center">
				<div class="col-12 text-right align-self-center py-5">
					<div class="section text-center py-5 py-md-0">
            <!-- <button class="pricing" id="pricing" name="pricing">翻轉</button> -->
			          	<input class="pricing" type="checkbox" id="pricing" name="pricing"/>
			          	<label for="pricing">
                            <span class="block-diff">kayakin
                            <span class="float-right">camping</span></span></label>
